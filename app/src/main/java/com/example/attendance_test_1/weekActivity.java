...
public class weekActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("week"); //테이블 이름
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    weekType wk=snapshot.getValue(weekType.class); //만들어뒀던 객체에 데이터를 담는다.
                    arrayList.add(wk); //담은 데이터들을 arraylist에 넣고 리사이클러뷰로 보낼 준비
                }
        ...
        adapter=new weekAdapter(arrayList, this);
