...
public class TclassroomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.classroom_t_main);
        ...
        databaseReference=database.getReference("professor"); //table 이름
